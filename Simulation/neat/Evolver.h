...
class Evolver {
  ...
  public:
    ...
    void initialize(size_t numInputs, size_t numOutputs,
                    std::shared_ptr<class ParentSelector> selector,
                    std::mt19937 &generator,
                    std::shared_ptr<NetworkGenotype> (*pGenotypeFactory)() =
                        defaultGenotypeFactory);
    ...
    void epoch(std::mt19937 &generator); // Assumes proper fitness levels for
                                         // this epoch have been set already
